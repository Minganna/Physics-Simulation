...
public:
	...
	*/
	...
	//Clear torques thta act on the object
	void ClearTorques() { _torque = glm::vec3(0.0f, 0.0f, 0.0f); }

	//Compute the inverse of the rigid body inertia tensor
	//using the current rotation matrix and the body inertia tensor at rest
	...
	*/
	...
	/*numerical integration fuction to compute the current velocity and the current position based 
	on the velocity and the position of the previous time step
	*/
	...
	*/
	...
	void SetdragCoeficent(float drag) { dragCoeficent = drag; }
...
private:
	...
	*/
	...
	glm::vec3 _angular_velocity= { 0.0f,0.0f,0.0f };
	glm::vec3 _angular_momentum = { 0.0f,0.0f,0.0f };
